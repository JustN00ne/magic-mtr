...
public abstract class RailsRequestSchema implements SerializedDataBase {
	...
	protected RailsRequestSchema() {
	}

	protected RailsRequestSchema(final ReaderBase readerBase) {
	}
