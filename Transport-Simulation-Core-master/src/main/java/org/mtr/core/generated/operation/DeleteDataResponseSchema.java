...
public abstract class DeleteDataResponseSchema implements SerializedDataBase {
	...
	protected final it.unimi.dsi.fastutil.longs.LongArrayList liftIds = new it.unimi.dsi.fastutil.longs.LongArrayList();
	...
	protected DeleteDataResponseSchema() {
	}

	protected DeleteDataResponseSchema(final ReaderBase readerBase) {
	}
	...
	public void updateData(final ReaderBase readerBase) {
		...
		readerBase.iterateLongArray("liftIds", liftIds::clear, liftIds::add);
	...
	protected void serializeLiftIds(final WriterBase writerBase) {
		final WriterBase.Array liftIdsWriterBaseArray = writerBase.writeArray("liftIds"); liftIds.forEach(liftIdsWriterBaseArray::writeLong);
	}
