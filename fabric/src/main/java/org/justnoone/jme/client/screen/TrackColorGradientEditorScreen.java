...
public class TrackColorGradientEditorScreen extends ScreenExtension {
    ...
    /**
     * Convenience ctor for opening this screen from vanilla screens (e.g., YACL).
     */
    public TrackColorGradientEditorScreen(net.minecraft.client.gui.screen.Screen parent, JmeConfig.TrackColorStop[] initialStops, SaveHandler saveHandler) {
        this(new Screen(parent), toDrafts(initialStops), saveHandler);
    }
